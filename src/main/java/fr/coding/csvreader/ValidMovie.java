...
public class ValidMovie implements Movie {
    ...
    public static ValidMovie create(String tconst, String titleType, String primaryTitle, String originalTitle, String isAdult, String startYear, String endYear, String runtimeMinutes, String genders) {
        return new ValidMovie(
                ...
                NULL_VALUE.equals(genders) ? null : List.ofAll(Arrays.asList(genders.split(COMMA_DELIMITER)))
        );
    }
